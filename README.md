...
| File | Contents |
|---|---|
| `te-araroa.gpx` | 15 tracks (main route, transport connectors, 13 bypasses), 574 waypoints typed `hut`/`campsite`/`town`/`resupply`/`food`/`accommodation`/`caravan-park`. The stable filename - link to this one |
| `te-araroa-2026-27.gpx` | the same bytes under this release's name |
...
- `.github/workflows/refresh.yml` — the weekly check.
